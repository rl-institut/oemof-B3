...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        try:
            ...
            logger.error('Note that you cannot load the same data into the table twice. There will be an id conflict.')
            logger.error('Delete and recreate with the commands above, if you want to test your upload again.')
