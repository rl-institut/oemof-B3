...
-------
filename_wind : str
    ''raw/time_series/ninja_wind_country_DE_current_merra-2_nuts-2_corrected.csv'': Path incl. file name to wind feed-in time series of renewables ninja
filename_pv : str
    ''raw/time_series/ninja_pv_country_DE_merra-2_nuts-2_corrected.csv'': Path incl. file name to pv feed-in time series of renewables ninja
filename_for : str
